...
// NON PRIMITIVE DATA TYPES ( complex in nature such as objects ) - mostly created by the developer
     ...
     * add one element to list using .add(element) colors.add("red");
     * add many elements to list .addAll([1,2,3]) books.addAll(["a", "b", "c"]);
     * insert at particular position .insert(position, item) => overwrites it books.insert(0, Flutter Cookbook) 
     * u can have a mixed data type list eg[1,2,"Hello", "World"]
     * remove(elementNam) or removeAt(index) --- books.removeAt(0);
     ...
     */ 
      ...
      * create -> var map ={key:value,} -----> 
      Map student ={
        ...
        'Age': 99,
        'ID': 654321,
        'Hostel':{'location': 'Nairobi W','Name':'Qwetu', 'Room No':101 } // Nested Map
      };
